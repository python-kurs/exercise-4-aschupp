...
data_dir = ("C:/Users/Alex/Documents/GitHub/exercise-4-aschupp/")
...
def create_climate_diagram(df, 
    ...
    ax2.bar(df.index, height = df[prec_col], color = "royalblue", width = 20, label = "Precipitation")
    ax1.plot(df[temp_col], color = "firebrick", label = "Temperature")
